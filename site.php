...
$app->get('/cart/:idproduct/minus', function ($idprodcut) {
    $product = new Product();
    $product->get((int) $idprodcut);
    $cart = Cart::getFromSession();
...
$app->get('/cart/:idproduct/remove', function ($idprodcut) {
    $product = new Product();
    $product->get((int) $idprodcut);
    $cart = Cart::getFromSession();
    ...
    $app->post('/profile', function () {
        ...
        $app->get('/boleto/:idorder', function ($idorder) {
          ...
          // DADOS DO SEU CLIENTE
            ...
            $order->getdescontry().' - CEP:'.$order->getdeszipcode();
           ...
           // DADOS PERSONALIZADOS - ITAÚ
            ...
            $app->post('/profile/change-password', function () {
                ...
                if ($_POST['new_pass'] !== $_POST['new_pass_confirm']) {
                    User::setError('Você digitou a senha diferente da nova senha.');
                    header('Location: /profile/change-password');
                    exit;
                }
                $user = User::getFromSession();
